...
async function activate(context) {
  import_coc2.window.showMessage(`coc-cucumber works!`);
  context.subscriptions.push(import_coc2.commands.registerCommand("coc-cucumber.Command", async () => {
    import_coc2.window.showMessage(`coc-cucumber Commands works!`);
  ...
  }), import_coc2.workspace.registerKeymap(["n"], "cucumber-keymap", async () => {
